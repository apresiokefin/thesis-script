...
do
	...
	name=(${name// / })
	name="${name[-2]}${name[-1]}"
	/usr/bin/pwo2xsf -oc ./out.o > tmp.xsf
	...
	array set xcMisc {ImageMagick.import /usr/bin/import ImageMagick.convertOptions {} reduce_to 3 external_xsf_name pwo2xsf.xsf rescale_image_list {up down left right center rotXY rotXZ rotYZ rotAB rotAC rotBC wireframes_2d pointlines_2d pipeballs_2d ballsticks2_2d ballsticks1_2d spacefills_2d spacefills_3d ballsticks_3d pipeballs_3d sticks_3d dm_wire dm_solid dm_anaglyph dm_stereo dm_smooth dm_flat rep_unit rep_asym} resolution 1366x768 gif_encoder convert babel /usr/bin/babel status_init_label {Building GUI ...} wm_rootYshift 0 movie_encoder ppmtompeg debug 0 ppmtompeg /usr/bin/ppmtompeg convert /usr/bin/convert titlefile /tmp/xc_3754/pwo2xsf.xsf xwd /usr/bin/xwd resolution_ratio1 1.0 resolutionX 1366 resolution_ratio2 1.0 wm_rootXshift 0 resolutionY 768 ImageMagick.convert /usr/bin/convert}

	# ------------------------------------------------------------------------
	# definition of printSetup
	# ------------------------------------------------------------------------

	array set printSetup {useOptions 0 optionEntry .print_setup.1.f1.2.entry2 useAntialias 0}
	...
	saveState:fontCreate font3 -family {DejaVu Sans} -size 2 -weight normal -slant roman -underline 0 -overstrike 0
	...
	saveState:fontCreate TkDefaultFont -family {DejaVu Sans} -size 0 -weight normal -slant roman -underline 0 -overstrike 0
	saveState:fontCreate TkMenuFont -family {DejaVu Sans} -size 0 -weight normal -slant roman -underline 0 -overstrike 0
	...
	saveState:fontCreate font15 -family {Nimbus Mono L} -size 14 -weight normal -slant roman -underline 0 -overstrike 0
	...
	saveState:fontCreate TkHeadingFont -family {DejaVu Sans} -size 0 -weight bold -slant roman -underline 0 -overstrike 0
	...
	saveState:fontCreate TkTooltipFont -family {DejaVu Sans} -size 0 -weight normal -slant roman -underline 0 -overstrike 0
	saveState:fontCreate TkTextFont -family {DejaVu Sans} -size 0 -weight normal -slant roman -underline 0 -overstrike 0
	saveState:fontCreate TkCaptionFont -family {DejaVu Sans} -size 0 -weight bold -slant roman -underline 0 -overstrike 0
	saveState:fontCreate TkSmallCaptionFont -family {DejaVu Sans} -size 0 -weight normal -slant roman -underline 0 -overstrike 0
	saveState:fontCreate TkFixedFont -family {DejaVu Sans Mono} -size 0 -weight normal -slant roman -underline 0 -overstrike 0
	saveState:fontCreate TkIconFont -family {DejaVu Sans} -size 0 -weight normal -slant roman -underline 0 -overstrike 0
	...
	set light Off
	Lighting Off
	array set mode2D   {PL Off SF Off WF Off BS1 Off PB Off BS2 On}
	array set mode3D   {space Off sticks Off pipe Off balls Off}
	array set dispmode {mode3D_name BS mode3D Preset mode3D_f2_packinfo {-in .ctrl.c.f.fr3 -anchor center -expand 1 -fill x -ipadx 0 -ipady 0 -padx 0 -pady 0 -side top} style 2D mode2D_name BS2 mode3D_ModeFrame .ctrl.c.f.fr3.2.a0}
	...
	xc_newvalue .mesa 8 5 0.800000 0.700000 0.000000
	xc_newvalue .mesa 8 6 0.900000 0.900000 0.900000
	xc_newvalue .mesa 8 7 0.100000 0.400000 0.900000
	...
	xc_newvalue .mesa 26 0.000000 0.000000 0.000000 1.0
	xc_newvalue .mesa 17 0.000000 0.000000 0.000000
	...
	xc_newvalue .mesa 7 0.200000000000000
	...
	array set check {pseudoDens 0 perspective 0 labels 0 depthcuing 0 crds 0 wigner 0 antialias 1 Hbonds 0 forces 0 frames 1 unibond 1 perpective 0}
	CrdSist
	AtomLabels
	CrysFrames
	Unibond
	...
	xc_translparam    set  0.000000000000000e+00  0.000000000000000e+00  4.482655866792883e+00 
	...
	ResetCursor
	destroy \$wait_window
	scripting::printToFile img.png
	exit
	EOF
#	update
#	after idle { scripting::printToFile }
	xcrysden -s xcrysden.script
	mv img.png /home/apresio/FeNC/Picture/$name.png
	cd $MYDIR
done
